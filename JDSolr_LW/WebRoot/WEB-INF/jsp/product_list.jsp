		...
		<div class="w" id="header-2013">
			...
			<div id="search-2013">
				<div class="i-search ld">
					...
					<form id="actionForm" action="list.gzsxt" method="POST">
						<div class="form">
						...
						<%-- <input type="hidden" name="catalogName" id="catalog_name" value="${cataName }" />  --%>
						<input type="hidden" name="catalogName" id="catalog_name" value="${caltalog_name }" /> 
						<input type="hidden" name="price" id="price" value="${price}" /> 
						<input type="hidden" name="currentPage" id="page" value="${result.currentPage }" /> 
						<input type="hidden" name="sort" id="sort" value="${sort }" />
<%-- 						<input type="hidden" name="cataName" id="catalog_name" value="${cataName }" /> 
						<input type="hidden" name="price" id="price" value="${price}" /> 
						<input type="hidden" name="curPage" id="page" value="${result.currentPage }" /> 
						<input type="hidden" name="sort" id="sort" value="${sort }" /> --%>
					</form>
				</div>
				<div id="hotwords"></div>
			...
			<div id="filter">
				...
				<div class="fore1">
					...
					<div class="pagin pagin-m">
						<%-- <span class="text"><i>${result.currentPage }</i>/${result.pageCount }</span> --%>
						<c:choose>
							<c:when test="${result.currentPage > 1}">
								<a href="javascript:changePage(-${result.currentPage }+1)" class="prev">首页<b></b></a>
								<a href="javascript:changePage(-1)" class="prev">上一页<b></b></a>
							</c:when>
						</c:choose>
						<span class="text"><i>${result.currentPage }</i>/${result.pageCount }</span>
						<c:choose>
							<c:when test="${result.currentPage < result.pageCount}">
								<a href="javascript:changePage(1)" class="next">下一页<b></b></a>
								<a href="javascript:changePage(${result.pageCount }-${result.currentPage })" class="next">尾页<b></b></a>
							</c:when>
						</c:choose>
					</div>
					<div class="total">
